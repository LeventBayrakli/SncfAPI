...
using SncfAPI.Models;

namespace SncfAPI.Controllers
{
    [Route("SncfAPI/[controller]")]
    [ApiController]
    public class TripController : ControllerBase
    {
        ...
        // GET: api/Trip/5
        [HttpGet("{idTrip}", Name = "Get")]
        public IEnumerable<Trip> Get(int idTrip)
        {
            //return "";
            return trips.Where(t => t.IdTrip == idTrip);
        }
